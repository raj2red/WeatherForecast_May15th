...
@Composable
fun WeatherDetailRow(weather: WeatherList) {
...
fun SunsetSunRiseRow(weather: WeatherList) {
    Row(modifier = Modifier
        ...
        verticalAlignment = Alignment.CenterVertically) {
        Row {
            Image(painter = painterResource(id = com.example.weatherforecase_may15th.R.drawable.img),
...
fun HumidityWindPressureRow(weather: WeatherList,
    ...
    Row(modifier = Modifier
        ...
        Row(modifier = Modifier.padding(4.dp)) {
            Icon(painter = painterResource(id = com.example.weatherforecase_may15th.R.drawable.humidity),
        ...
        Row() {
            Icon(painter = painterResource(id = com.example.weatherforecase_may15th.R.drawable.pressure),
        ...
        Row() {
            Icon(painter = painterResource(id = com.example.weatherforecase_may15th.R.drawable.wind),
